...
import me.rayzr522.hitcounter.command.CommandHitCounter;
import me.rayzr522.hitcounter.utils.MessageHandler;
...
public class HitCounter extends JavaPlugin {
    private static HitCounter instance;
    private MessageHandler messages = new MessageHandler();

    /**
     * @return The current instance of HitCounter.
     */
    ...
    public void onEnable() {
        ...
        // Set up commands
        getCommand("hitcounter").setExecutor(new CommandHitCounter(this));
    }
